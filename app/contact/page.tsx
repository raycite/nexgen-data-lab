...
export const metadata: Metadata = {
  ...
  description: "Contact NexGen Data Lab about research, training, mentorship, datasets and collaboration opportunities.",
  ...
  return (
    <main id="main-content" className="min-h-screen bg-white text-slate-900">
      ...
      <section className="relative overflow-hidden bg-[#00102B] px-4 py-14 text-white sm:px-6 sm:py-16">
        ...
        <div className="absolute -right-20 bottom-0 h-72 w-72 rounded-full bg-[#FF6500]/15 blur-3xl" />
        <div className="relative mx-auto max-w-4xl text-center">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#FF6500]">Contact & Collaborate</p>
          <h1 className="mt-4 text-3xl font-bold sm:text-5xl">Let&apos;s start a useful conversation.</h1>
          <p className="mx-auto mt-5 max-w-2xl leading-7 text-slate-300 sm:text-lg">Reach out about research, training, mentorship, datasets or another idea that aligns with the NexGen Data Lab community.</p>
        </div>
      </section>
      ...
      <section className="px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="rounded-3xl bg-slate-50 p-6 sm:p-8">
            <p className="text-sm font-bold uppercase tracking-[0.16em] text-[#FF6500]">Ways to work with us</p>
            ...
            <a href="mailto:nextgendatalab@gmail.com?subject=Collaboration%20with%20NextGen%20Data%20Lab" className="mt-6 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#FF6500] px-6 font-semibold text-white transition hover:bg-[#E85B00]">Start a conversation <Mail className="h-4 w-4" aria-hidden="true" /></a>
          </div>
        </div>
      </section>
