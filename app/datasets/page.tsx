    ...
    <main id="main-content" className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section className="relative overflow-hidden bg-[#00102B] px-4 py-14 text-white sm:px-6 sm:py-16">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#FF6500]">NexGen Data Hub</p>
          ...
          <p className="mx-auto mt-5 max-w-3xl leading-7 text-slate-300 sm:text-lg">A growing home for responsibly documented datasets from Ghana and other African contexts—shared by researchers, students and the NexGen Data Lab team.</p>
          <a href="#contribute" className="mt-7 inline-flex min-h-12 items-center gap-2 rounded-full bg-[#FF6500] px-6 font-semibold text-white transition hover:bg-[#E85B00]">Submit a dataset <UploadCloud className="h-5 w-5" aria-hidden="true" /></a>
        </div>
      </section>
          ...
          <article className="mt-8 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
            <div className="grid lg:grid-cols-[0.72fr_1.28fr]">
              ...
              <div className="p-6 sm:p-8">
                <p className="text-xs font-bold uppercase tracking-[0.16em] text-[#FF6500]">NexGen Data Lab research</p>
      ...
      <section id="contribute" className="scroll-mt-20 bg-white px-4 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto grid max-w-6xl gap-8 rounded-3xl bg-[#00102B] p-7 text-white sm:p-10 lg:grid-cols-[1fr_0.8fr] lg:items-center">
          <div><p className="text-xs font-bold uppercase tracking-[0.18em] text-[#FF6500]">Contribute data</p><h2 className="mt-3 text-3xl font-bold">Share a Ghanaian or African research dataset</h2><p className="mt-4 max-w-2xl leading-7 text-slate-300">Researchers, students and organisations can submit responsibly collected datasets for review. Include a clear description, source, collection method, licence or access conditions, and confirmation that sensitive personal information has been removed or appropriately protected.</p></div>
          <div className="rounded-2xl bg-white/10 p-6"><h3 className="font-bold">How submission works for now</h3><ol className="mt-4 space-y-3 text-sm leading-6 text-slate-200"><li>1. Attach the dataset to an email, or share a Drive, GitHub, Zenodo or repository link.</li><li>2. Include its topic, location, formats, source and intended use.</li><li>3. The team reviews the documentation, permissions and privacy considerations before publishing.</li></ol><a href="mailto:nextgendatalab@gmail.com?subject=Dataset%20Contribution%20to%20NexGen%20Data%20Hub" className="mt-5 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#FF6500] px-5 font-semibold text-white transition hover:bg-[#E85B00]"><Mail className="h-5 w-5" aria-hidden="true" />Email your submission</a></div>
        </div>
      </section>
