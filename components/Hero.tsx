        ...
        <div className="relative z-10 max-w-xl">
          ...
          <h1 className="reveal-2 text-[3rem] leading-[.96] text-[#FFFDF8] min-[420px]:text-5xl sm:text-6xl lg:text-[72px]">
            ...
            <span className="relative inline-block">
              <span className="hero-highlight relative z-10 bg-gradient-to-r from-[#FF6500] via-[#FF9A45] to-[#FF6500] bg-[length:200%_100%] bg-clip-text text-transparent">
                AI Future.
              </span>

              <span className="hero-underline absolute bottom-0 left-0 h-[3px] w-full origin-left rounded-full bg-[#FF6500]" />
            </span>
          </h1>
          ...
          <div className="relative aspect-[596/450] w-full max-w-[650px] overflow-hidden">
            ...
            >
              ...
              <g transform="translate(167 7) scale(.72 .88)" className="hero-map-outline">
                ...
                <g fill="#FF6500" filter="url(#packetGlow)"><circle cx="190" cy="205" r="7" /><circle cx="304" cy="228" r="7" /><circle cx="392" cy="294" r="7" /></g>
